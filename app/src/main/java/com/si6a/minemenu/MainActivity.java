...
import com.si6a.minemenu.databinding.ActivityMainBinding;
                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if (idMenu==R.id.action_edit){
                            ...
                            builder.setMessage("Are you sure want to delete it? "+data.get(position).getNamamenu()+ data.get(position).getHarga()+data.get(position).getDeskripsi()+"?");
